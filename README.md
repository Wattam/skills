...
- **`development-pipeline/`** — skills that form one feature-development workflow (spec → plan → test → cross-check → implement → review-code → adress-review). See `development-pipeline/README.md`.
