...
- `init-agents-md` — generates a minimal `AGENTS.md` for the current repository.
...
- `standalone-address-review` — validates review findings and fixes confirmed issues without pipeline documents.
